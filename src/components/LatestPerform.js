...
export default function LatestPerform() {
  return (
    <div className='py-60px lg:py-[147px]'>
        <div className='bg_star_pattern text_pattern relative text-[#3EB59F] text-center text-4xl leading-tight lg:text-5xl lg:leading-[58px] font-extrabold pt-7 pb-16 px-7 w-fit mx-auto'>Latest Performing Content</div>
